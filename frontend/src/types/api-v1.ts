...
export const ErrorCode = {
  ...
  SKILL_IMPORT_INVALID: 'SKILL_IMPORT_INVALID',
  SKILL_CONFLICT: 'SKILL_CONFLICT',

  // DISTILL
  DISTILL_LLM_UNAVAILABLE: 'DISTILL_LLM_UNAVAILABLE',
  DISTILL_INSUFFICIENT_EVIDENCE: 'DISTILL_INSUFFICIENT_EVIDENCE',
  DISTILL_GENERATION_FAILED: 'DISTILL_GENERATION_FAILED',
